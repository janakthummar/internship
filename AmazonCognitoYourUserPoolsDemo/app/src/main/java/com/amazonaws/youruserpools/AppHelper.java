...
public class AppHelper {
     ...
     */
    private static final String userPoolId = "us-east-1_ry6ychAk4";

    /**
     * Add you app id
     */
    private static final String clientId = "2r9v3lmdpklntsdjdujj9q37eq";
     ...
     */
    private static final String clientSecret = "aves38qdrtifcjcedun9nodkutk9s0a5dt3f51mgauekh1a2mml";
